...
export default function VotingMonitorPage({ params }: { params: { id: string } }) {
          ...
          <div className="p-6 flex flex-col md:flex-row justify-center items-center gap-8 border-t bg-gray-50">
            <div className="flex flex-col items-center">
              ...
              <div className="mt-2 text-center">
                <div className="text-xl font-bold">:{votingData.results.favor}</div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-2 text-center">
                <div className="text-xl font-bold">:{votingData.results.contra}</div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-2 text-center">
                <div className="text-xl font-bold">:{votingData.results.abstencion}</div>
